package com.example.doodledigits.googlesigninclient
    ...
    private suspend fun handleSingIn(result: GetCredentialResponse): Boolean {
        ...
        if (
            ...
            try {
                ...
                println(tag + "name: ${tokenCredential.familyName}")
        ...
        val request = GetCredentialRequest.Builder()
            .addCredentialOption(
                GetGoogleIdOption.Builder()
                    ...
                    .setServerClientId(
                        "785362869543-3uif857jtqcqufgav5qseaj56jg7665v.apps.googleusercontent.com"
                    )
